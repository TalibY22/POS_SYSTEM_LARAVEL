...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        ...
        <h6 class="fw-normal">All Done, Great Job. Your software is ready to run. <a style="color:red;" href="https://cutt.ly/PLFZenO" target="_blank">NULLED Web Community</a></h6>
    </div>
